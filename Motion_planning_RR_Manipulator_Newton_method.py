# -*- coding: utf-8 -*-
"""problem6_Newton_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XexliYdiiJpg_dpvnL6qwSBnqs9RKrN2
"""
...
# defining function that gives JL+
def JL_pos(J):
  lambda2 = 0.05
  return np.linalg.inv(J.T@J + lambda2*np.identity(3))@J.T
...
#cchecking the equations for Newton Algorithm
q_k1 = q1 + (JL_pos(Jq1)@err)
